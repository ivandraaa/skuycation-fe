...
<h1 class="heading-title-detail"> Green Park </h1>
<section class="home-about">
    <div class="image">
        <img src="/images/hotel/greenpark.svg" alt="gambar alila">
    </div>
    &emsp;
    <div class="content">
        <h3>Fasilitas</h3>
        ...
        <form action="/book.php" method="GET">
            <input type="text" name="previews_name" value="Green Park" hidden>
            <button class="btn-price" type="submit">Book Now</button>
        </form>
        <!-- <a href="/book.php" class="btn">book now</a> -->
        <a class="btn-price">Rp 400.000 / Malam</a>
    </div>
</section>
