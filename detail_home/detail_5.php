...
<h1 class="heading-title-detail">Grand Cakra Hotel</h1>
<section class="home-about">
    ...
    <div class="content">
        ...
        <form action="/book.php" method="GET">
            <input type="text" name="previews_name" value="Grand Cakra Hotel" hidden>
            <button class="btn" type="submit">Book Now</button>
            <a class="btn-price">Rp 600.000 / Malam</a>
        </form>
